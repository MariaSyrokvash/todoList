...
export const GetTasks = () => {
	...
	return <div> {JSON.stringify(state)}
		<input value={todoListID} placeholder={'todoListID'} onChange={(event) => {
			setTodolist(event.currentTarget.value)
		}}/>
...
export const CreateTask = () => {
	...
	return <div> {JSON.stringify(state)}
		...
		<div>
			<input value={todoListID} onChange={(event) => {
				setTodolistID(event.currentTarget.value)
			}} placeholder={'todoListID'}/>
			<input value={titleTask} onChange={(event) => {
...
export const UpdateTask = () => {
	...
	return <div> {JSON.stringify(state)}
		...
		<div>
			<input value={taskId} onChange={(event) => {
				setTaskId(event.currentTarget.value)
			}} placeholder={'taskId'}/>
			<input value={todoListId} onChange={(event) => {
				setTodoListId(event.currentTarget.value)
			...
			<input value={deadline} onChange={(event) => {
				setDeadline(event.currentTarget.value)
			}} placeholder={'deadline'}/>
			<input value={addedDate} onChange={(event) => {
				setAddedDate(event.currentTarget.value)
			}} placeholder={'addedDate'}/>
			<input value={status} onChange={(event) => {
				setStatus(event.currentTarget.valueAsNumber)
			}} placeholder={'status'}/>
			<input value={priority} onChange={(event) => {
				setPriority(event.currentTarget.valueAsNumber)
			}} placeholder={'priority'}/>
			<input value={order} onChange={(event) => {
